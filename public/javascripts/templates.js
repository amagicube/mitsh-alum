...
templates['tweet'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\r\n<div class=\"tweet\" data-tweet-id="
    ...
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.userIsAuthor : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</div>\r\n";
},"useData":true});
